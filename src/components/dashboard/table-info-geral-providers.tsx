...
export default function TableInfoGeralProviders() {
  return (
    <Table>
      ...
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="text-zinc-400 uppercase">categoria</TableHead>
      ...
      <TableBody>
        <TableRow>
          ...
          <TableCell className="text-zinc-800">Montagem de armário</TableCell>
